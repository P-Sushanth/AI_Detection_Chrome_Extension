...
- [ ] **1. Cross-Search Engine Visual Verification**
...
- [ ] **2. Accuracy & False Positive Calibration**
...
- [ ] Extension works end-to-end when loaded unpacked in Google Chrome.
- [ ] Badges show subtle, instant score indications without disturbing search engine UX.
